  ...
  return (
    <header className="relative min-h-[100vh] bg-hero-gradient flex flex-col justify-center items-center px-4 overflow-hidden border-b border-liberty-border">
      ...
      <motion.img
        ...
        className="hidden md:block absolute inset-0 w-full h-full object-cover z-0 object-[center_10%]"
      />
      ...
      <div className="max-w-4xl mx-auto text-center relative z-20 space-y-8">
        ...
        >
          <Link to="/#preview" className="w-full sm:w-auto px-10 py-4 rounded-4xl font-bold bg-liberty-card border border-liberty-border text-liberty-text transition-all duration-300 hover:bg-liberty-border/40 hover:text-liberty-cyan cursor-pointer">
            Conocer Propuestas
          </Link>
          <Link
            to="/sumate"
            className="w-full sm:w-auto px-10 py-4 rounded-4xl font-bold bg-[#C026D3] border border-[#C026D3] text-white hover:bg-[#A21CAF] transition-all duration-300 cursor-pointer"
          >
            Súmate al partido
          </Link>
        </motion.div>
