...
export default function NosotrosPreview() {
  ...
  return (
    <section
      id="nosotros"
      className="relative w-full py-24 flex justify-center px-4 md:px-16 xl:px-36 transform-gpu translate-z-0"
    >
      <div className="w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-12 items-center">
          ...
          <m.div
            ...
            className="flex flex-col space-y-8 lg:col-span-7 pr-0 lg:pr-10 will-change-transform"
          >
            ...
            <div className="hidden lg:block ">
              <CinematicLink
                to="/nosotros"
                className="group relative inline-flex items-center justify-center w-auto px-8 py-4  text-white font-bold uppercase text-xs tracking-[0.2em] bg-liberty-card border border-liberty-border rounded-4xl hover:bg-liberty-border/40 hover:border-liberty-primary"
              >
          ...
          >
              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/[0.02] transition-colors duration-500 group-hover:border-white/20">
                <div className="grid grid-cols-2 gap-2 auto-rows-[200px] sm:auto-rows-[250px] lg:auto-rows-[360px] md:p-0 ">
                  {gallery.map((item, idx) => (
                    <img
                      key={idx} // ¡Agregado el key para que React no tire warning!
                      src={item.src}
                      alt={item.alt}
                      loading="lazy"
                      decoding="async"
            ...
            <div className="pt-10 lg:hidden flex flex-col items-center space-y-8">
              ...
              <CinematicLink
                to="/nosotros"
                className="group relative flex items-center justify-center w-full sm:w-auto px-8 py-4  text-white font-bold uppercase text-xs tracking-[0.2em] bg-liberty-card border border-liberty-border rounded-4xl"
              >
                Conocer nuestra historia
              </CinematicLink>
            </div>
