...
export default function PropuestasPreview() {
  return (
    <section className="relative w-full py-6 lg:py-32 bg-liberty-bg overflow-hidden font-satoshi mb-10">
      ...
      {/* LUZ DE FONDO (Le da profundidad al mapa y une la sección con tu paleta) */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 flex justify-center relative group">
            {/* Círculo de luz dinámico detrás del mapa (Brilla más en Hover) */}
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 lg:space-y-8">
            ...
            <div className="space-y-2">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white uppercase tracking-tight leading-none drop-shadow-md">
            ...
            <div className="pt-2 w-full sm:w-auto">
              ...
              >
                {/* Animación de destello estilo rayo láser pasando por el botón (Opcional pero muy estético) */}
      ...
      {/* Agregamos el keyframe para la animación de brillo del botón (shimmer) */}
