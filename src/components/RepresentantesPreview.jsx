  ...
  return (
    <section id="representantes" className="relative w-full py-24 md:py-32 bg-liberty-bg text-liberty-text overflow-hidden border-t border-liberty-border font-satoshi">
      ...
      <div className="w-full px-6 md:px-12 lg:px-20 max-w-[1600px] mx-auto relative z-10">
        ...
        {/* Contenedor principal para controlar la animación */}
        <motion.div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
            ...
            <div className="lg:col-span-7 relative flex justify-center items-center w-full h-[450px] sm:h-[600px] lg:h-[700px]">
              <div className="relative w-full max-w-[400px] sm:max-w-[550px] lg:max-w-full h-full">
                ...
                {/* Imagen 4 */}
                <motion.div
                  initial={hasAnimated ? { opacity: 0.6, x: 0, y: 0 } : { opacity: 0, x: -30, y: -30 }}
                  whileInView={hasAnimated ? false : { opacity: 0.6, x: 0, y: 0 }}
                  viewport={{ once: true }}
                ...
                {/* Imagen 3 */}
                <motion.div
                  initial={hasAnimated ? { opacity: 0.7, x: 0, y: 0 } : { opacity: 0, x: 30, y: -20 }}
                  whileInView={hasAnimated ? false : { opacity: 0.7, x: 0, y: 0 }}
                  viewport={{ once: true }}
                ...
                {/* Imagen 2 */}
                <motion.div
                  initial={hasAnimated ? { opacity: 0.85, x: 0, y: 0 } : { opacity: 0, x: -20, y: 30 }}
                  whileInView={hasAnimated ? false : { opacity: 0.85, x: 0, y: 0 }}
                  viewport={{ once: true }}
