...
export default function SeccionPropuestas() {
  ...
  return (
    <section className="overflow-hidden bg-liberty-bg text-white">
      <header className="relative isolate flex min-h-[99svh] items-end overflow-hidden  ">
        ...
        <m.div
          ...
          className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-25 pt-32 sm:px-8 md:pb-29 lg:px-12"
        >
